...
const Checkout = () => {
    ...
    // --- 3. GIAO DIỆN (JSX) ---
    return (
        <div className="checkout-page-container" style={{ fontFamily: 'Arial, sans-serif' }}>
                    ...
                    <div className="checkout-form-group" style={{marginTop: '25px'}}>
                        ...
                        <div className="payment-options" style={{display: 'flex', flexDirection: 'column', gap: '12px'}}>
                            ...
                            <label className={`payment-option ${paymentMethod === 'COD' ? 'active' : ''}`} 
                                   style={{display: 'flex', alignItems: 'center', gap: '15px', padding: '15px', border: paymentMethod === 'COD' ? '2px solid #007bff    ' : '1px solid #ddd', borderRadius: '8px', cursor: 'pointer', background: '#fff', transition: 'all 0.2s'}}>
                                <input 
                                    type="radio" name="payment" value="COD" 
                                    checked={paymentMethod === 'COD'}
                                    onChange={(e) => setPaymentMethod(e.target.value)}
                                    style={{accentColor: '#007bff', transform: 'scale(1.2)'}}
                                />
                                <div>
                            ...
                            <label className={`payment-option ${paymentMethod === 'BANKING' ? 'active' : ''}`}
                                   style={{display: 'flex', alignItems: 'center', gap: '15px', padding: '15px', border: paymentMethod === 'BANKING' ? '2px solid #007bff' : '1px solid #ddd', borderRadius: '8px', cursor: 'pointer', background: '#fff', transition: 'all 0.2s'}}>
                                <input 
